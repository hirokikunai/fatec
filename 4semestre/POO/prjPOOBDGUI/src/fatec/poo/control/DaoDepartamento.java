...
public class DaoDepartamento {
    ...
    public void inserir(Departamento departamento) {
        ...
        try {
            ps = conn.prepareStatement("INSERT INTO poo_tbdepartamento(Sigla_Dep, Nome_Dep) VALUES(?,?)");
    ...
    public void alterar(Departamento departamento) {
        PreparedStatement ps = null;
        try {
            ps = conn.prepareStatement("UPDATE poo_tbdepartamento set Nome_Dep = ?" +
                                                 "where Sigla_Dep = ?");
     ...
     public  Departamento consultar (String sigla) {
        ...
        PreparedStatement ps = null;
        try {
            ps = conn.prepareStatement("SELECT * from poo_tbDepartamento where " +
                                                 "Sigla_Dep = ?");
     ...
     public void excluir(Departamento departamento) {
        PreparedStatement ps = null;
        try {
            ps = conn.prepareStatement("DELETE FROM poo_tbdepartamento where Sigla_Dep = ?");
